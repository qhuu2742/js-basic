...
ListSelectYear.forEach(
    function (el, index) {
        // console.log('các phần tử trong list select là: ', el);
...
var selectCountry = document.querySelector('select[name="country"]');
...
for (let index = 0; index < countryList.length; index++) {
    var option = document.createElement('option');
    option.setAttribute('value', countryList[index]);
